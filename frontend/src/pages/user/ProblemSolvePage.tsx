...
export default function ProblemSolvePage() {
  ...
  if (loading) {
    ...
    return (
      ...
      <div className="app-background flex h-[calc(100vh-64px)] items-center justify-center">
  ...
  return (
    ...
    <div className="app-background flex h-[calc(100vh-64px)] min-h-0 flex-col overflow-hidden">
        ...
        <Group orientation="horizontal">
          ...
          >
            ...
            <div className="app-surface app-border flex h-full min-h-0 flex-col overflow-hidden rounded-md border">
              ...
              <div className="app-border flex h-11 shrink-0 items-center border-b px-2">
